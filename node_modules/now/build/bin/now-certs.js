...
function run(token) {return __async(function*(){
  ...
  if (subcommand === 'ls' || subcommand === 'list') {
    ...
    const yes = yield readConfirmation(cert, 'The following certificate will be renewed\n')
    ...
    const yes = yield readConfirmation(cert, 'The following certificate will be replaced permanently\n')
    if (!yes) {
      error('User abort')
      return exit(0)
    }
    ...
    const yes = yield readConfirmation(cert, 'The following certificate will be removed permanently\n')
    if (!yes) {
      error('User abort')
      return exit(0)
    }
